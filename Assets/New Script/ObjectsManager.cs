...
public class ObjectsManager: MonoBehaviour
{
    ...
    //유형에 따른 오브젝트 생성 함수
    public GameObject InstantiateObject(Property.TaskType _taskType, int _taskID, float _x, float _y, GameObject _record){
        ...
        switch(_taskType){
            case Property.TaskType.Holder:
                ...
                _taskObject.GetComponent<Object_Script>().RecordObj = _record;
    ...
    public GameObject InstantiateObject(GameObject[] _objects, GameObject _record){
        ...
        obj.GetComponent<Object_Script>().RecordObj = _record;
